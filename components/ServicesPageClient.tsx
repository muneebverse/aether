...
import { ArrowRight, CheckCircle2, Users, Zap, Clock, Layout, FileText, Presentation, Store, Sparkle } from 'lucide-react';
        ...
        <div className="container-aether">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="font-display font-bold text-4xl sm:text-5xl mb-6 text-sky-white">
                We build your complete professional identity
              </h1>
              <p className="text-lg text-sky-white/90 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Magnetic strength={0.15}>
                  <Link href="/pricing" className="btn btn-primary bg-sky-white text-aether-electric-teal hover:bg-aether-bright-cyan hover:text-aether-deep-teal">
                    View Pricing
                    <ArrowRight size={18} className="ml-2" />
                  </Link>
                </Magnetic>
                <Link href="/request" className="btn btn-secondary border-sky-white text-sky-white hover:bg-sky-white/10">
                  Request a Quote
                </Link>
              </div>
            </div>
