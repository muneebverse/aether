...
export default function RequestModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-aether-deep-teal/40 backdrop-blur-sm" onClick={onClose} />
      <div className="relative bg-sky-white rounded-expansive p-8 max-w-xl w-full max-h-[90vh] overflow-y-auto shadow-card">
        ...
        {orderId ? (
          <div className="text-center space-y-6 py-4">
            ...
            <div className="bg-white border border-aether-electric-teal/15 rounded-tight p-4 flex items-center justify-between font-mono text-lg text-deep-ink">
