...
export default async function LeadDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-sky-white border-b border-aether-electric-teal/10 px-6 py-4 flex items-center gap-4">
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        <div className="bg-white border border-aether-electric-teal/10 rounded-xl p-6 space-y-4">
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-deep-ink/80 whitespace-pre-wrap">{lead.instructions || '—'}</p>
          </div>
          <div>
        ...
        <div className="bg-white border border-aether-electric-teal/10 rounded-xl p-6">
