            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {projects.map((project) => (
                  <tr key={project.id} className="border-b border-aether-electric-teal/5 last:border-0 hover:bg-aether-electric-teal/5 transition-colors">
                    <td className="px-4 py-3 font-medium text-deep-ink">{project.title}</td>
                    <td className="px-4 py-3 text-deep-ink/70 capitalize">{project.category}</td>
                    <td className="px-4 py-3 text-deep-ink/50">{project.order_index}</td>
